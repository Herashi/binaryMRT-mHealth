...
group_all[[1]][["n"]] = 200
group_all[[1]][["group_id"]] = rep(1:200,each=1)
group_all[[1]][["e_g sigma2"]] = rep(0,200)
group_all[[1]][["b_g sigma2"]] = rep(0.5^2,200)

group_all[[2]][["n"]] = 200
group_all[[2]][["group_id"]] = rep(1:100,each=2)
group_all[[2]][["e_g sigma2"]] = rep(0,100)
group_all[[2]][["b_g sigma2"]] = rep(0.5^2,100)

group_all[[3]][["n"]] = 200
group_all[[3]][["group_id"]] = rep(1:50,each=4)
...
group_all[[4]][["b_g sigma2"]] = rep(0.5^2,40)

group_all[[5]][["n"]] = 200
group_all[[5]][["group_id"]] = rep(1:25,each=8)
group_all[[5]][["e_g sigma2"]] = rep(0,25)
group_all[[5]][["b_g sigma2"]] = rep(0.5^2,25)

group_all[[6]][["n"]] = 200
group_all[[6]][["group_id"]] = rep(1:20,each=10)
group_all[[6]][["e_g sigma2"]] = rep(0,20)
group_all[[6]][["b_g sigma2"]] = rep(0.5^2,20)

group_all[[7]][["n"]] = 204
group_all[[7]][["group_id"]] = rep(1:17,each=12)
group_all[[7]][["e_g sigma2"]] = rep(0,17)
group_all[[7]][["b_g sigma2"]] = rep(0.5^2,17)

group_all[[8]][["n"]] = 195
group_all[[8]][["group_id"]] = rep(1:13,each=15)
group_all[[8]][["e_g sigma2"]] = rep(0,13)
group_all[[8]][["b_g sigma2"]] = rep(0.5^2,13)

group_all[[9]][["n"]] = 198
group_all[[9]][["group_id"]] = rep(1:11,each=18)
group_all[[9]][["e_g sigma2"]] = rep(0,11)
group_all[[9]][["b_g sigma2"]] = rep(0.5^2,11)
